	...
	<view class="container">
		...
		<view class="introduce-section">
			...
			<view class="price-box">
				...
				<text class="price">{{info.retailPrice}}</text>
				<text class="m-price">¥{{info.counterPrice}}</text>
		...
		<view class="detail-desc">
			...
			<rich-text :nodes="desc" class="richText" width="100%"></rich-text>
		</view>
...
<script>
	...
	export default {
		...
		async onLoad(options) {
			...
			uni.request({
				url: 'https://www.xinghuohan.cn/xhh-wx-api/wx/goods/detail?id=' + id,
				method: 'GET',
				data: {},
				success: res => {
					console.log(res);
					...
					// 处理后台返回的图片地址值
					let arr = res.data.data.info.gallery;
